...
* Third, in the next year either contribute on someone else's R package or write my own. I don't require this to be a published project on [CRAN](https://cran.r-project.org/), but I do plan to have it posted on Github. 
