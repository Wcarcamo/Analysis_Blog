...
The package [flexdashboard](https://rmarkdown.rstudio.com/flexdashboard/) makes it easy to create dashboards. I used the *mtcars* dataset to create an example of a dashboard. 
