...
Every Tuesday, I often see submissions from the [#rstats](https://twitter.com/search?q=%23rstats&src=tyah) community on twitter about their [#TidyTuesday](https://twitter.com/search?q=%23TidyTuesday&src=tyah) projects. #TidyTuesdays are weekly data projects posted online by the R4DS (R for Data Science) community for anyone interested in working on developing their skills wrangling data within the R ecosystem. Feel free to check out the [#tidytuesday](https://github.com/rfordatascience/tidytuesday) repository on github for more information. 
...
The TidyTuesday repository also provides a "data dictionary" table in their repository that defines each variable so we can have a better understanding of what we are working. Instead of recreating it from scratch, I want to attempt to scrape the information from their github page. This might be overkill for a 6 X 3 table but I have recently stumbled upon [Engaging the Web with R](https://m-clark.github.io/webR/) by Michael Clark. In it he demonstrated pulling data from a [table](https://en.wikipedia.org/wiki/List_of_cities,_villages,_and_townships_in_Michigan) found on Wikipedia. I was inspired to one day try it out myself and I think this is a great opportunity to implement it. 
