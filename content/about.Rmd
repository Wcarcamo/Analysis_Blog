...
I came to Sacramento to start my career working for [LPC Consulting, Inc.](https://lpc-associates.com/){target="_blank"} as a research associate, but am now working for California Correctional Health Care Services as a research data analyst II.

```{r, cchcs}
div(
  img(src = "https://media.licdn.com/dms/image/C560BAQEK9X6zDJxgiw/company-logo_200_200/0?e=2159024400&v=beta&t=9jELSTsZ_5Nmk3XOKNRQY-MMCG5wJ1l8eRfOiq1gKxw", alt="CCHCS Logo", style = "width:200px;height;200px;"),  align = "center"
)
```
